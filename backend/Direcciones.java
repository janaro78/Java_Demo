package backend;
// Código responsable de mostrar y gestionar las direcciones en la base de datos.
import data.JDBC;
import frontend.AddAddress;
...
public class Direcciones extends SuperPlantilla{
       ...
       super("Direcciones");
        ...
        addAddress.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                addAddress.setVisible(true); // Muestra ventana
            }
        });
